...
|--------|-------------|-------|
| snirt/[**agenmux**](https://github.com/snirt/agenmux) | Monitor AI coding agents in tmux panes with sidebar and status-line views | 46 |
...
| Ataraxy-Labs/[**opensessions**](https://github.com/Ataraxy-Labs/opensessions) | tmux sidebar for coding agents Amp, Claude Code, Codex, and OpenCode with per-thread markers | 1227 |
| accessd/[**tmux-agent-indicator**](https://github.com/accessd/tmux-agent-indicator) | Visual feedback for AI agent states in pane borders and status bar | 92 |
...
| samleeney/[**tmux-agent-status**](https://github.com/samleeney/tmux-agent-status) | Show which tmux sessions have AI agents working or idle | 276 |
...
| Plugin | Description | Stars |
|--------|-------------|-------|
| Kristijan/[**flash-copy.tmux**](https://github.com/Kristijan/flash-copy.tmux) | Flash.nvim-style word jumping and copying | 48 |
...
| IngoMeyer441/[**tmux-easy-motion**](https://github.com/IngoMeyer441/tmux-easy-motion) | Vim-easymotion-like pane navigation | 108 |
| abhinav/[**tmux-fastcopy**](https://github.com/abhinav/tmux-fastcopy) | Easymotion-style text copying | 97 |
| Morantron/[**tmux-fingers**](https://github.com/Morantron/tmux-fingers) | Vimium-like copy and paste hints | 1471 |
...
| wfxr/[**tmux-fzf-url**](https://github.com/wfxr/tmux-fzf-url) | Quick URL opening with fzf | 733 |
...
| tmux-plugins/[**tmux-pain-control**](https://github.com/tmux-plugins/tmux-pain-control) | Standard pane key-bindings for tmux | 868 |
| sandudorogan/[**tmux-pane-tree**](https://github.com/sandudorogan/tmux-pane-tree) | Interactive pane tree sidebar with Vim-style navigation | 59 |
...
| greymd/[**tmux-xpanes**](https://github.com/greymd/tmux-xpanes) | Terminal divider and pane utility | 2107 |
| artemave/[**tmux_super_fingers**](https://github.com/artemave/tmux_super_fingers) | Open file links from terminal in Vim | 106 |
| christoomey/[**vim-tmux-navigator**](https://github.com/christoomey/vim-tmux-navigator) | Seamless navigation between Vim and tmux | 6292 |

## Session

| Plugin | Description | Stars |
|--------|-------------|-------|
| joshmedeski/[**sesh**](https://github.com/joshmedeski/sesh) | Smart terminal session manager | 2821 |
| tmux-plugins/[**tmux-continuum**](https://github.com/tmux-plugins/tmux-continuum) | Continuous saving of tmux environment | 4072 |
...
| tmux-plugins/[**tmux-resurrect**](https://github.com/tmux-plugins/tmux-resurrect) | Persists tmux environment across system restarts | 13051 |
...
| omerxx/[**tmux-sessionx**](https://github.com/omerxx/tmux-sessionx) | Session manager with zoxide and fuzzy finding | 1378 |
...
| thewtex/[**tmux-mem-cpu-load**](https://github.com/thewtex/tmux-mem-cpu-load) | CPU, RAM, and system load monitor | 1130 |
| MunifTanjim/[**tmux-mode-indicator**](https://github.com/MunifTanjim/tmux-mode-indicator) | Display current active Tmux mode | 201 |
...
| olimorris/[**tmux-pomodoro-plus**](https://github.com/olimorris/tmux-pomodoro-plus) | Pomodoro timer integration | 471 |
...
| YousefHadder/[**tmux-speedtest**](https://github.com/YousefHadder/tmux-speedtest) | Run internet speed tests and display results in the status bar | 6 |
...
| semi710/[**minimal-tmux-status**](https://github.com/semi710/minimal-tmux-status) | Minimal and clean status bar theme | 275 |
| catppuccin/[**tmux**](https://github.com/catppuccin/tmux) | Soothing pastel theme for Tmux | 3169 |
| dracula/[**tmux**](https://github.com/dracula/tmux) | Dark theme for Tmux | 857 |
| nordtheme/[**tmux**](https://github.com/nordtheme/tmux) | Arctic north-bluish clean color theme | 1198 |
...
| vaaleyard/[**tmux-dotbar**](https://github.com/vaaleyard/tmux-dotbar) | Simple and minimalist dot-style status bar theme | 291 |
| egel/[**tmux-gruvbox**](https://github.com/egel/tmux-gruvbox) | Light and dark gruvbox color scheme | 699 |
...
| 2KAbhishek/[**tmux2k**](https://github.com/2KAbhishek/tmux2k) | Customizable powerline status bar framework | 466 |
...
| laktak/[**extrakto**](https://github.com/laktak/extrakto) | Clipboard copy and fzf completions from output | 1141 |
...
| sainnhe/[**tmux-fzf**](https://github.com/sainnhe/tmux-fzf) | Manage tmux environment with fzf | 1504 |
...
| tmux-plugins/[**tmux-logging**](https://github.com/tmux-plugins/tmux-logging) | Logging and screen capturing utilities | 1258 |
| jaclu/[**tmux-menus**](https://github.com/jaclu/tmux-menus) | Popup menus for environment management | 538 |
...
| rickstaa/[**tmux-notify**](https://github.com/rickstaa/tmux-notify) | Notify when long-running processes finish | 277 |
| tmux-plugins/[**tmux-open**](https://github.com/tmux-plugins/tmux-open) | Open highlighted files and URLs from copy mode | 740 |
| eduwass/[**tmux-palette**](https://github.com/eduwass/tmux-palette) | Raycast-style fast and scriptable command palette for tmux | 407 |
...
| tmux-plugins/[**tmux-sensible**](https://github.com/tmux-plugins/tmux-sensible) | A set of tmux options that should be acceptable to everyone | 2225 |
...
| azorng/[**tmux-smooth-scroll**](https://github.com/azorng/tmux-smooth-scroll) | Smooth scrolling in copy mode | 79 |
...
| alexwforsythe/[**tmux-which-key**](https://github.com/alexwforsythe/tmux-which-key) | Customizable popup menu for keybinding discovery | 320 |
| gcla/[**tmux-wormhole**](https://github.com/gcla/tmux-wormhole) | Download files with magic wormhole | 122 |
| tmux-plugins/[**tmux-yank**](https://github.com/tmux-plugins/tmux-yank) | Tmux plugin for copying to system clipboard | 3108 |
